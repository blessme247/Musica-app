...
const Charts = () => {
  return (
    <div className='flex flex-col w-[28%]'>
            ...
            <div className='bg-[#1a1e1f] flex justify-between items-center rounded-[20px] p-3 mt-3'>
                <img src={cardImage} className='rounded-[10px] h-50px] w-[70px] object-cover object-center' alt="artiste image" />
